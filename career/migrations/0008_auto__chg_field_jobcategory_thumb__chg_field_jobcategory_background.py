...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JobCategory.thumb'
        db.alter_column(u'career_jobcategory', 'thumb', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))

        # Changing field 'JobCategory.background'
        db.alter_column(u'career_jobcategory', 'background', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'JobCategory.thumb'
        db.alter_column(u'career_jobcategory', 'thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'JobCategory.background'
        db.alter_column(u'career_jobcategory', 'background', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'career.job': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 2, 0, 0)'}),
