...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('career_job', 'project', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Job.project'
        db.alter_column('career_job', 'project', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'career.job': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 7, 0, 0)'}),
