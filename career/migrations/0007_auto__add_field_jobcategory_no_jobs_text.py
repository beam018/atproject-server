...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCategory.no_jobs_text'
        db.add_column(u'career_jobcategory', 'no_jobs_text',
                      self.gf('ckeditor.fields.RichTextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCategory.no_jobs_text'
        db.delete_column(u'career_jobcategory', 'no_jobs_text')
    ...
    models = {
        ...
        u'career.job': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 8, 0, 0)'}),
